...
const InfoCard = ({ firstColor, secondColor }) => {
  return (
    <div className="info-container mt-14 max-w-[614px] h-80 md:h-[392px] rounded-lg bg-[#212345] border-[.8px] border-[#363970] ">
      ...
      <div className="flex flex-col gap-6 pt-10 text-xl font-medium">
        ...
        <div className="w-full flex justify-between px-5">
          <p>
            Start Time <span className="text-lg font-light ml-2">08:10 PM</span>{" "}
          </p>
          <p>
            End Time <span className="text-lg font-light ml-3">4h 20m 30sec</span>{" "}
          </p>
        </div>
        <div className="w-full flex justify-between px-5">
          <p>Matched</p>
